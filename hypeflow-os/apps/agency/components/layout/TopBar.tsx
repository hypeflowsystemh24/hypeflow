...
const ALERTS = [
  { id: 1, text: 'João Silva aguarda resposta há 2h', time: '2m', href: '/comercial' },
  { id: 2, text: 'Call com Carlos Mendes em 15 min', time: '14m', href: '/calls' },
  { id: 3, text: 'Nova resposta no formulário de qualificação', time: '1h', href: '/formularios' },
]
          ...
          {alertsOpen && (
            ...
            >
              ...
              <div className="px-4 py-3">
                <button
                  onClick={() => { setAlertsOpen(false); router.push('/calls') }}
                  className="w-full text-sm font-semibold py-2 rounded-xl tonal-hover"
          ...
          {userMenuOpen && (
            ...
            >
              <div className="px-4 py-3" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <p className="text-[10px] mt-0.5" style={{ color: 'var(--t3)' }}>Agência</p>
              </div>
              <button
                onClick={() => { setUserMenuOpen(false); router.push('/config') }}
                className="w-full flex items-center gap-3 px-4 py-2.5 tonal-hover text-sm transition-colors"
                style={{ color: 'var(--t2)' }}
              >
