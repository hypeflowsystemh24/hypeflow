...
const NOTIFICATIONS = [
  { id: 1, text: 'A sua call de amanhã está confirmada', time: '1h', href: '/calls' },
  { id: 2, text: 'Relatório de Março disponível', time: '3h', href: '/roi' },
  { id: 3, text: '3 novos leads esta semana', time: '1d', href: '/leads' },
]
